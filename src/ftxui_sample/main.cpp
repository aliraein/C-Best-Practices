...
// configuration step. It creates a namespace called `C_Best_Practices`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", C_Best_Practices::cmake::project_name, C_Best_Practices::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", C_Best_Practices::cmake::project_version);
      return EXIT_SUCCESS;
    }
